import '../styles/chooseCar/_chooseCar.scss';
import MainCar from '../images/chooseUs/main.png';
        ...
        <div className="choose-section">
            <div className="container">
                <div className="choose-container">
                    <img src={MainCar} alt="choose car" />
                    <div className="text-container">
                        <div className="text-container__left">
                            ...
                            <a href="#home" >Find Details <i className="fa-solid fa-angle-right"></i></a>
                        </div>
